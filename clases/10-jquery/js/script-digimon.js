// jquery se añade con un <script> en el head esta vez.
// esta version de jquery es la min, porque con la slim no funciona la funcion $.get
$("document").ready(function(){
    ...
    $.get("https://digimon-api.vercel.app/api/digimon", function(data, status)
    {
        ...
        {
            $("digimon-list").html("error digimon");
        }
    });
